...
const producerAgent = "mobile-interaction"

// Producer publishes ApprovalRelayEvents and DLQ messages.
...
// PublishRelay sends an approval relay event with all mandatory headers.
func (p *Producer) PublishRelay(
	ctx context.Context,
	payload interface{},
