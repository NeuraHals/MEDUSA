...
const producerAgent = "recovery-agent"

// Producer publishes RecoveryEvents and DLQ messages.
...
// PublishRecovery sends a RecoveryEvent with all mandatory headers.
func (p *Producer) PublishRecovery(
	ctx context.Context,
